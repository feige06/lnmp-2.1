...
Install_PHP_Swoole()
{
    ...
    if echo "${Cur_PHP_Version}" | grep -Eqi '^8.[0-3].'; then
        Download_Files ${Download_Mirror}/swoole/${PHPSwoole_Ver}.tgz ${PHPSwoole_Ver}.tgz
        ...
        Download_Files ${Download_Mirror}/swoole/swoole-4.8.13.tgz swoole-4.8.13.tgz
        ...
        Download_Files ${Download_Mirror}/swoole/swoole-4.5.11.tgz swoole-4.5.11.tgz
        ...
        Download_Files ${Download_Mirror}/swoole/swoole-4.3.6.tgz swoole-4.3.6.tgz
        ...
        Download_Files ${Download_Mirror}/swoole/swoole-1.10.5.tgz swoole-1.10.5.tgz
