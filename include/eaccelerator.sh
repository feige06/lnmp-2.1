...
Install_Old_eA()
{
    ...
    Download_Files ${Download_Mirror}/eaccelerator/eaccelerator-0.9.5.3.tar.bz2 eaccelerator-0.9.5.3.tar.bz2
...
Install_New_eA()
{
    ...
    Download_Files ${Download_Mirror}/eaccelerator/eaccelerator-0.9.6.1.tar.bz2 eaccelerator-0.9.6.1.tar.bz2
...
Install_Dev_eA()
{
    ...
    Download_Files ${Download_Mirror}/eaccelerator/eaccelerator-eaccelerator-42067ac.tar.gz eaccelerator-eaccelerator-42067ac.tar.gz
