...
Install_PHP_Sodium()
{
    ...
    if echo "${Cur_PHP_Version}" | grep -Eqi '^7.[234].|8.[0-3].'; then
        ...
        Download_Files ${Download_Mirror}/sodium/${PHPSodium_Ver}.tgz ${PHPSodium_Ver}.tgz
        ...
        Download_Files ${Download_Mirror}/sodium/libsodium-1.0.7.tgz libsodium-1.0.7.tgz
