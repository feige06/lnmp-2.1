...
Install_ImageMagic()
{
    ...
    if [ -s /usr/local/imagemagick/bin/convert ]; then
        ...
        Download_Files ${Download_Mirror}/imagemagick/${ImageMagick_Ver}.tar.xz ${ImageMagick_Ver}.tar.xz
    ...
    Download_Files ${Download_Mirror}/imagick/${Imagick_Ver}.tgz ${Imagick_Ver}.tgz
